...
/// External definition of function pointers used as handlers for encoders.
extern void (*encoderHandler[MAX_NUMBER_OF_ENCODERS])(uint8_t id, int8_t steps);

/// When set to true, preset encoder is used to change MIDI channels instead of presets.
bool midiChannelEncState;

/// Array holding last time in milliseconds encoders were moved.
...
/// Enables or disables MIDI channel changing mode for preset encoder.
...
/// Checks if MIDI channel changing mode for preset encoder is enabled.
