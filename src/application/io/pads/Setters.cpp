...
/// Enables or disables pad edit mode.
...
/// Enables or disables split mode.
...
/// Enables or disables sending of requested MIDI message.
...
/// Changes MIDI channel on requested pad.
...
/// Changes curve for CC MIDI messages on requested coordinate.
...
/// Changes CC value on requested coordinate.
...
/// Changes CC limit value (minimum or maximum) on requested coordinate and specified pad.
...
/// Enables or disables calibration mode for requested coordinate.
...
/// Writes new upper calibration value for pressure on specified pad pressure zone.
...
/// Writes new lower or upper calibration value for X or Y coordinate on specified pad.
/// @param [in] pad                 Pad for which new calibration value is being written.
...
/// Adds or removes note to requested pad.
...
/// Shifts scale up or down by requested number of octaves or changes active octave during pad edit mode.
...
/// Shift entire predefined scale up or down without changing tonic (root note).
...
/// Updates state of pad (pressed or released)
...
/// Sets correct state on function LEDs if split mode is enabled.
...
/// Sets correct state on note LEDs.
...
/// Updates press state for requested pad.
...
/// Changes active pitch bend type.
...
/// Enables or disables pitch bend sending.
...
/// Displays all currently active LEDs by checking pad notes.
