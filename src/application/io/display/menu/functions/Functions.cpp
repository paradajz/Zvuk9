...
/// Used to display software and hardware info.
/// @param [in] argument    Function argument defined in menu layout.
/// \returns                True on success, false otherwise.
...
/// Used to initiate setting up of calibration mode.
/// @param [in] argument    Function argument defined in menu layout.
/// \returns                True on success, false otherwise.
...
/// Used to either check or change aftertouch type.
...
/// Used to either check or change running status.
...
/// Used to either check or change MIDI note off type.
...
/// Used to either check or change type of transport controls.
...
/// Used to either check or change pitch bend type.
...
/// Used to either check or change velocity sensitivity.
...
/// Used to either check or change pressure curve.
