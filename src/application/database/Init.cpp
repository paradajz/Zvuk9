...
/// Writes custom values in database.
...
/// Initializies program block in database with correct values.
...
/// Initializies scale block in database with correct values.
...
/// Initializies global settings block in database with correct values.
