...
const char function_y[] PROGMEM = "Y send state changed!";
const char function_aftertouch[] PROGMEM = "Aftertouch send state changed!";
const char function_notes[] PROGMEM = "Note send state changed!";
