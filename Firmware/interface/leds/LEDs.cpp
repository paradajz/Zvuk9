...
void LEDs::init()   {
    ...
    setOutputMacro(DECODER_OUT_1_PORT, DECODER_OUT_1_PIN_INDEX);
    setOutputMacro(DECODER_OUT_2_PORT, DECODER_OUT_2_PIN_INDEX);
    setOutputMacro(DECODER_OUT_3_PORT, DECODER_OUT_3_PIN_INDEX);
