...
void Menu::createUserMenuLayout()   {
...

    {
        ...
        menuItem[userMenuItem_pressureSensitivity_4].stringPointer = pressure_sensitivity_4;
        menuItem[userMenuItem_pressureSensitivity_4].level = 14;
        menuItem[userMenuItem_pressureSensitivity_4].function = NULL;
