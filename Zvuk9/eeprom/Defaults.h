...
typedef enum {  //list of IDs for global program settings for access
    ...
    GLOBAL_PROGRAM_SETTING_AFTERTOUCH_TYPE_ID,
...
#define GLOBAL_PROGRAM_SETTING_AFTERTOUCH_ENABLE    0x00
...
const uint8_t defaultGlobalProgramSettingArray[GLOBAL_PROGRAM_SETTINGS] = {
    ...
    GLOBAL_PROGRAM_SETTING_AFTERTOUCH_TYPE,
...
#define LOCAL_PROGRAM_SETTING_AFTERTOUCH_ENABLE    0x00
...
#define DEFAULT_PAD_X_LIMIT_LOWER                   448
#define DEFAULT_PAD_X_LIMIT_UPPER                   590

#define DEFAULT_PAD_Y_LIMIT_LOWER                   455
#define DEFAULT_PAD_Y_LIMIT_UPPER                   590
